...
CONFIG_SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "COMMAND_EFFECT_TOLERANCE_W": {"group": "Regelung", "label": "Absolute Soll/Ist-Toleranz für Zielwerttracking", "type": "int", "min": 10, "max": 500, "unit": "W", "description": "Absolute Mindesttoleranz für das Zielwerttracking. RC13 verwendet den größeren Wert aus dieser absoluten Toleranz und der relativen Prozenttoleranz."},

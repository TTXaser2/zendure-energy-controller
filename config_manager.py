...
CONFIG_SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "COMMAND_RESYNC_ON_MQTT_RECOVERY_ALWAYS": {"group": "Regelung", "label": "Zendure-Command-Resync bei MQTT-Recovery", "type": "bool", "description": "Wenn Zendure-MQTT nach Stale/No-Live wieder OK wird und ein aktiver Nicht-Null-Sollwert anliegt, sendet ZEC acMode/inputLimit/outputLimit erzwungen erneut. Schützt nach Restore/Broker-/Zendure-App-MQTT-Hängern."},

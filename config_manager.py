...
CONFIG_SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "COMMAND_EFFECT_MIN_TARGET_W": {"group": "Regelung", "label": "Mindest-Sollwert für Wirksamkeitsdiagnose", "type": "int", "min": 0, "max": 500, "unit": "W", "description": "Kleine Sollwerte unterhalb dieser Schwelle erzeugen keine harte COMMAND_NOT_EFFECTIVE-Warnung."},
    "COMMAND_EFFECT_MIN_W": {"group": "Regelung", "label": "Mindest-Istleistung für Command-Wirkung", "type": "int", "min": 30, "max": 500, "unit": "W", "description": "Schwellwert, ab dem eine Lade-/Entlade-Istleistung als plausible Wirkung eines aktiven Sollwerts zählt."},
    "COMMAND_EFFECT_TOLERANCE_W": {"group": "Regelung", "label": "Soll/Ist-Toleranz für Command-Wirkung", "type": "int", "min": 10, "max": 500, "unit": "W", "description": "Toleranz, innerhalb derer Soll- und Istleistung als wirksam/recovered gelten."},
    "COMMAND_EFFECT_TIMEOUT_SECONDS": {"group": "Regelung", "label": "Warnzeit Soll/Ist-Wirkung", "type": "int", "min": 10, "max": 600, "unit": "s", "description": "Nach dieser Zeit warnt ZEC, wenn ein aktiver Nicht-Null-Sollwert anliegt, aber Zendure nahe 0 W bleibt oder in die falsche Richtung läuft."},
    "COMMAND_EFFECT_FORCE_RESEND_SECONDS": {"group": "Regelung", "label": "Resend-Zeit Soll/Ist-Wirkung", "type": "int", "min": 30, "max": 900, "unit": "s", "description": "Nach dieser Zeit sendet ZEC einen weiterhin unwirksamen aktiven Sollwert erzwungen erneut. Der Wert sollte größer/gleich der Warnzeit sein."},

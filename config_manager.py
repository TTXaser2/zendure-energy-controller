...
CONFIG_SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "SMA_DISCHARGE_BLOCK_W": {"group": "Zweitbatterie", "subgroup": "Cross-Charge-Schutz", "label": "Entlade-Blockgrenze (Legacy)", "type": "int", "min": 0, "max": 5000, "unit": "W", "description": "Legacy-Wert für ältere Konfigurationen. Neue Installationen verwenden Cross-Charge-Signifikanzschwelle."},

...
CONFIG_SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "ZENDURE_LOCAL_API_CONTROL_TIMEOUT_CAP_SECONDS": {"group": "Netzwerk", "label": "Zendure lokale API Request-Timeoutdeckel", "type": "float", "min": 0.2, "max": 5.0, "unit": "s", "description": "Begrenzt den Hintergrundrequest unabhängig vom höheren allgemeinen API-Timeout. Seit RC18 blockiert die lokale API den Regelzyklus nicht mehr."},

...
CONFIG_SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "SMA_ENERGY_METER_SUSY_ID": {"group": "Netzwerk", "label": "SMA Energy Meter SUSy-ID", "type": "str", "description": "Optionaler Filter auf die SMA SUSy-ID des gewünschten Energy Meters. Bei mehreren SMA Energy Metern empfohlen. Beispiel aus UniMeter-Konfiguration: 372."},
    ...
    "SMA_ENERGY_METER_SOCKET_MODE": {"group": "Netzwerk", "label": "SMA Socket-Modus", "type": "select", "options": {"rc3_compatible": "RC3-kompatibel / SO_REUSEPORT best-effort", "reuseaddr_only": "Nur SO_REUSEADDR", "unimeter_like": "UniMeter-naher Join ohne IP_MULTICAST_IF", "group_bind": "Diagnose: bind auf Multicast-Gruppe"}, "description": "Experten-/Diagnoseoption für die Koexistenz mit EVCC, UniMeter oder weiteren SMA-Speedwire-Listenern auf demselben Host. Standard rc3_compatible entspricht dem im Live-Test stabilen RC3-Verhalten."},

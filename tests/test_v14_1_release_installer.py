...
def test_installer_is_exact_v15_0_0_to_v15_0_2():
    ...
    for token in ('EXPECTED_VERSION_ARG="v16_0_1"','EXPECTED_SOURCE_VERSION="15.0.3"','EXPECTED_SOURCE_BUILD_ID="v15.0.3-20260911"','EXPECTED_TARGET_VERSION="16.0.1"','EXPECTED_TARGET_BUILD_ID="v16.0.1-20260915"'):
...
def test_installer_records_hash_verified_full_release_backup():
    ...
    assert 'INSTALL_REPORT="/tmp/zec_v16_0_1_install_report.json"' in script

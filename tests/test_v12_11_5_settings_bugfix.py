...
UPDATER = ROOT / "tools" / "install_zendure_controller.sh"
...
class V12115SettingsBugfixTests(unittest.TestCase):
    ...
    def test_updater_accepts_only_v13_0_3_and_keeps_transitional_readback_gate(self):
        ...
        for marker in (
            ...
            'TRANSITIONAL_STREAK', 'PYTHONWARNINGS="error::ResourceWarning"',
        ):
            self.assertIn(marker, script)
        self.assertIn('INSTALL_MODE="$(python3 -c', script)

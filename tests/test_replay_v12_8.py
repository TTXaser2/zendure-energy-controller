...
from tools.replay_core import CSV_SCHEMA, AnalysisLimits, analyze_files, summary_csv
...
class ReplayV128Tests(unittest.TestCase):
    ...
    def test_multi_file_analysis_reports_regulator_and_cross_charge_quality(self):
        f1 = self._write_csv([
            f"{CSV_SCHEMA};12.8;1000;3;2026-05-29 10:00:00;50;0;0;0;0;50;HOLD;;0;ok\n",
            f"{CSV_SCHEMA};12.8;1003;3;2026-05-29 10:00:03;-300;500;120;-500;500;51;CHARGE;SMA_DISCHARGE;1;ok\n",
        ])
        f2 = self._write_csv([
            f"{CSV_SCHEMA};12.8;1006;3;2026-05-29 10:00:06;250;-400;-350;0;0;50;DISCHARGE;;1;ok\n",
        ])
        try:
    ...
    def test_multi_file_limits_reject_too_many_files(self):
        f = self._write_csv([f"{CSV_SCHEMA};12.8;1000;3;2026-05-29 10:00:00;0;0;0;0;0;50;HOLD;;0;ok\n"])
        try:

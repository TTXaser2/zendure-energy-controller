...
class V1302BackfillAndUiContractTests(unittest.TestCase):
    ...
    def test_installer_is_strict_v13_0_1_to_v13_0_2(self):
        ...
        for marker in (
            'EXPECTED_VERSION_ARG="v16_0_1"', 'EXPECTED_SOURCE_VERSION="15.0.3"',
            'EXPECTED_SOURCE_BUILD_ID="v15.0.3-20260911"', 'EXPECTED_TARGET_VERSION="16.0.1"',
            'EXPECTED_TARGET_BUILD_ID="v16.0.1-20260915"', 'SOURCE_MANIFEST="V16_0_1_SOURCE_MANIFEST.sha256"',
        ):

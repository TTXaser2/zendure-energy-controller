...
def test_v15_0_1_identity_exact_upgrade_source_and_package_contract():
...
def test_v15_0_1_installer_preserves_runtime_data_and_verifies_ui_bugfix_assets():
    script = (ROOT / "tools/update_zendure_controller.sh").read_text(encoding="utf-8")
    for token in (
...
def test_v15_0_1_field_acceptance_targets_new_release_and_ui_fix_contracts():
...
def test_v15_0_1_does_not_change_modbus_transport_contract_or_greenfield_api_identity():

...
class TestV1601InstallerHotfix(unittest.TestCase):
    def test_current_release_identity_is_v16_1_0(self):
    ...
    def test_identity_cli_executes_the_same_parser_used_by_installer(self):
        ...
        self.assertEqual("16.1.0", payload["identity"]["version"])

        command[command.index("16.1.0")] = "16.0.0"
    ...
    def test_installer_uses_shared_identity_gate_without_embedded_regex(self):
        ...
        self.assertIn('EXPECTED_VERSION_ARG="v16_1_0"', installer)
        self.assertIn('EXPECTED_TARGET_VERSION="16.1.0"', installer)
        self.assertIn('EXPECTED_TARGET_BUILD_ID="v16.1.0-20260919"', installer)
